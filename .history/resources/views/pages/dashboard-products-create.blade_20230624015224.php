                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="price" id="incomeInput" disabled/><a class="text-danger">* </a>
                            <p class="text-secondary"> Pendapatan toko akan dikurangi 1%</p>
                          </div>
                        </div>
