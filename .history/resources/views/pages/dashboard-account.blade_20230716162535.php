          ...
          >
            <div class="container-fluid">
              <div class="dashboard-heading">
                ...
                <p class="dashboard-subtitle">Perbaharui profil anda!</p>
                              ...
                              <div class="col-md-4">
                                <div class="form-group">
                                  ...
                                  <select name="regencies_id" id="regencies_id" class="form-control" v-if="regencies" v-model="regencies_id">
                                    <option v-for="regency in regencies" value="{{ $user->regencies->name }}" :value="regency.id" :key="regency.id">@{{ regency.name }}</option>
                                  </select>
                                  <select v-else class="form-control"> <option>Loading...</option></select>
                                </div>
                              </div>
