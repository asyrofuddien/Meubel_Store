    ...
    <div class="page-content page-cart">
      ...
      <section class="store-cart">
        <div class="container">
          ...
          <div class="row" data-aos="fae-up" data-aos-delay="150">
            <div class="col-12">
              <hr />
            </div>
            <div class="col-12">
          ...
          <form action="{{ route('checkout') }}" id="locations" enctype="multipart/form-data" method="POST" target="_blank">
            @csrf
            ...
            <div class="row" data-aos="fade-up" data-aos-delay="200">
              <div class="col-4 col-md-2 mb-4">
                <div class="product-titel">Rp. 0</div>
              ...
              <div class="col-4 col-md-2 mb-4">
                <div class="product-titel text-success">Rp. {{ number_format($totalPrice ?? 0) }}</div>
